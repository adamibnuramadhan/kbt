...
export default function AnimatedTruck() {
  ...
  const bgColor = theme === 'light' ? '#f8f9fb' : '#0c0e14'
  ...
  return (
    <div className="w-full h-full min-h-[200px] lg:min-h-screen bg-[var(--bg-primary)] relative overflow-hidden flex items-center justify-center">
      ...
      <div className="absolute top-0 left-0 right-0 h-8 lg:h-64 bg-gradient-to-b from-[var(--bg-primary)] via-[var(--bg-primary)]/50 to-transparent pointer-events-none" />
      <div className="absolute bottom-0 left-0 right-0 h-8 lg:h-64 bg-gradient-to-t from-[var(--bg-primary)] via-[var(--bg-primary)]/50 to-transparent pointer-events-none" />
      <div className="absolute top-0 bottom-0 left-0 w-8 lg:w-64 bg-gradient-to-r from-[var(--bg-primary)] via-[var(--bg-primary)]/50 to-transparent pointer-events-none" />
      <div className="absolute top-0 bottom-0 right-0 w-8 lg:w-64 bg-gradient-to-l from-[var(--bg-primary)] via-[var(--bg-primary)]/50 to-transparent pointer-events-none" />
